                ...
                <form method="post" action="proses-order.php">
                   ...
                   <div class="form-group">
                    <label>ORDER DATE: </label>
                     <input type="text" name="order_date" class="form-control" placeholder="YYYY-MM-DD" required="required">
                   </div>
                   <div class="form-group">
                   ...
                   <div class="form-group">
                    ...
                    <label>FRIEGHT: </label>
                     <input type="text" name="frieght" class="form-control" placeholder="XX.XX" required="required">
                   </div><div class="form-group">
                   ...
                   <div class="form-group">
                      <input type="submit" name="login" class="btn btn-primary btn-block" value="ORDER">
                   </div>
                  </form>
          </div>
        </div>
