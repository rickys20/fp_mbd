...
<head>
  <meta charset="utf-8">
	...
	<title>PPDB Institut Teknologi Sepuluh Nopember</title>
</head>
...
<body>
  ...
  <!--lalu saya membuat semacam peringatan yang akan membantu user, apakah password dan username berbeda dan peringatan bila registrasi berhasil-->
    <?php
  	if(isset($_GET['pesan'])){
  		if($_GET['pesan']=="gagal"){
