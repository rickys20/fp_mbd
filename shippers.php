...
<div class="jumbotron jumbotron-fluid">
    <div class="container">
        ...
        <div class="container">
          <h1 class="display-4" align="center">SHIPPERS</h1>
        </div>
          <div class="container">
              <div class="row justify-content-center mt-5">
                <div class="col-md-2">
                  <form action="new-shipper.php"><!--lalu, fungsi di sebelah ini akan membawa kita ke laman register-->
                      <div class="form-group">
          ...
          <div class="row justify-content-left mt-0">
            <div class="col-md-11">
              ...
              <?php
                ...
                $query = "SELECT * FROM shippers ORDER BY shipper_id";
                ...
                <th style="width:60%;">PHONE</th>
                  ...
                  while($pg = pg_fetch_array($result)){
                      ...
                      echo "<td>".$pg['shipper_id']."</td>";
                      echo "<td>".$pg['company_name']."</td>";
                      echo "<td>".$pg['phone']."</td>";
                      
                      echo "<td>";
                      echo "<a href='form-edit-shipper.php?id=".$pg['shipper_id']."'>Edit</a> | ";
                      echo "<a href='hapus-shipper.php?id=".$pg['shipper_id']."'>Hapus</a>";
                      echo "</td>";
